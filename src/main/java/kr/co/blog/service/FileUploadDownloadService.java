package kr.co.blog.service;
        ...
        import kr.co.blog.exception.FileDownloadException;
        import kr.co.blog.exception.FileUploadException;
...
public class FileUploadDownloadService {
    ...
    public FileUploadDownloadService(FileUploadProperties prop){
        ...
        try{
            ...
            throw new FileUploadException("파일을 업로드할 디렉토리를 생성하지 못했습니다.");
        }
    }
